...
ancombc = function(phyloseq, formula, p_adj_method = "holm", zero_cut = 0.90,
  ...
  print("debug AA fiuo_prep$feature_table:")
  print(head(fiuo_prep$feature_table, 5))
  ...
  print("debug BB fiuo_para$beta:")
  print(head(fiuo_para$beta, 5))
  beta = fiuo_para$beta
  d = fiuo_para$d
  e = fiuo_para$e
  ...
  print("debug CC fiuo_fit$beta_hat:")
  print(head(fiuo_fit$beta_hat, 5))
